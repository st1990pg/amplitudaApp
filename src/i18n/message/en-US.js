...
=======
    ...
      decades and does not plan to stop. Enrolls all candidates good
      will, so don't worry if there is room for you. If you want, just
      step inside. It's easy to find, it's capitalized
