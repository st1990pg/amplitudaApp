...
function SampleNextArrow(props) {
  ...
  return (
    <div
      className={className}
      style={{ ...style, display: "block", width: "9.38%", height:"100%",
...
function SamplePrevArrow(props) {
  ...
  return (
    <div
      className={className}
      style={{ ...style, display: "block",width: "9.38%",left: "-9.5%", height:"100%",
      ...
      <div className="slider">
        <div className="slider-wrapper">
          <div className="slider-header">
              ...
              <span className="button-arrow-wrapper"><ButtonArrow  text="Ostale vijesti" fontSize="18px" link="#"></ButtonArrow></span>
          </div>
